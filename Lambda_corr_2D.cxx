...
bool DoAnalysis(TChain *L_tree, const int ReadMode, const int cut_type = 0, const int energy = 510, const int year = 2017, const int test = 0)
{
  ...
  for(unsigned int pTbin1 = 0; pTbin1 < nPtBins_corr; pTbin1++)
  {
    ...
    //***********shao fei hua, ni GPA duo shao ? ****************
    for(int mi1 = 0 ; mi1 < nPtBins_corr ;mi1 ++){
        for(int mi2 = 0 ; mi2 < nPtBins_corr; mi2++ ){
...
void Lambda_corr_2D(const int ReadMode = 0, const int cut_type = 0, const int energy = 200, const int year = 2012, const int test = 0)
{  
  ...
  if(energy == 200)
  {
    if(year == 2012)
    {
      fileList.open("/gpfs01/star/pwg/fliu/LL_Spin_Correlation/2012data/BigTree/FileList.txt");
    }
