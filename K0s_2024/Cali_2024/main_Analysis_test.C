...
int main(int argc, char*argv[]){
	...
	std::string OutPutFile = "K0s_P24iyHelixScaledMass_plot_eta1p0.root"; 
	...
	ntp_K0s_Analyzer *myAnalyzer = new ntp_K0s_Analyzer(mySameEventReader,myHistogram,myEventSelecter,myK0sSelecter,1.000,0.996,10);
