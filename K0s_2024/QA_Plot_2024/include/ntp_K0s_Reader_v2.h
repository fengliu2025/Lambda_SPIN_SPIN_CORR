...
#ifndef ntp_K0s_Reader_h
#define ntp_K0s_Reader_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           NK0s;
   Int_t           p1_InEventID[50];   //[NK0s]
   Float_t         p1_pt[50];   //[NK0s]
   Float_t         p1_phi[50];   //[NK0s]
   Float_t         p1_eta[50];   //[NK0s]
   Float_t         p1_dca[50];   //[NK0s]
   Float_t         p1_dcaxy[50];   //[NK0s]
   Float_t         p1_nSigmaPion[50];
   Int_t           p1_ch[50];   //[NK0s]
   Int_t           p1_hasTOFinfo[50];   //[NK0s]
   Float_t         p1_dedx[50];   //[NK0s]
   Float_t         p1_beta[50];   //[NK0s]
   Int_t           p2_InEventID[50];   //[NK0s]
   Float_t         p2_pt[50];   //[NK0s]
   Float_t         p2_phi[50];   //[NK0s]
   Float_t         p2_eta[50];   //[NK0s]
   ...
   Int_t           pair_charge[50];   //[NK0s]
   Float_t         pair_DCAdaughters[50];   //[NK0s]
   Float_t         pair_theta[50];   //[NK0s]
   Float_t         pair_decayL[50];   //[NK0s]
   Float_t         pair_phi[50];   //[NK0s]
   Float_t         pair_eta[50];   //[NK0s]
   Float_t         pair_pt[50];   //[NK0s]
   Float_t         pair_mass[50];   //[NK0s]
   ...
   ntp_K0s_Reader(std::vector<std::string> Infiles);
   ntp_K0s_Reader(std::vector<std::vector<std::string>> Infiles);
   virtual ~ntp_K0s_Reader();
   virtual void     Init(TTree *tree);
};



ntp_K0s_Reader::ntp_K0s_Reader(std::vector<std::string> Infiles) 
   : fChain(0), InputFiles(Infiles)
{

}

ntp_K0s_Reader::ntp_K0s_Reader(std::vector<std::vector<std::string>> Infiles) 
...
void ntp_K0s_Reader::Init(TTree *tree)
{
