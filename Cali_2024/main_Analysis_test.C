...
int main(int argc, char*argv[]){
	...
	std::ifstream filelist("/gpfs01/star/pwg/fliu/production/pp2024/PicoDstLambda_P24iy_wTrk/FileList.txt");

	if (!filelist.is_open()) {
		std::cerr <<"can't open the file" <<std::endl;
	}
	std::string directory="/gpfs01/star/pwg/fliu/production/pp2024/PicoDstLambda_P24iy_wTrk/";
	std::string line;
	...
	std::string OutPutFile = "Lambda_P24iyHelixScaledMass_plot_eta1p5.root"; 
